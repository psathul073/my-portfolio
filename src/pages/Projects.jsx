      ...
      <section id='recent-project' className='full-project'>
        ...
        <Motion.div initial={{opacity: 0, y: 100}} whileInView={{opacity: 1, y: 0}}  viewport={{ once: true, amount: 0.2 }} transition={{ type: 'spring', damping: 15, bounce: 0.30}} className='project-container'>
          ...
          <div className='more-project'>
            ...
            <Motion.div initial={{opacity: 0, scale: 0}} whileInView={{opacity: 1, scale: 1}}  viewport={{ once: true, amount: 0.2 }} transition={{ type: 'spring', damping: 15, bounce: 0.30}} className='links'>
